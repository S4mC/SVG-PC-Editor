 ...
 * Cory S.N. LaViska
 * A Beautiful Site ({@link http://abeautifulsite.net/})
 * Modified by Alexis Deveria
 *
 * More info: {@link http://abeautifulsite.net/2008/09/jquery-context-menu-plugin/}
 *
 * @module jQueryContextMenu
 * @todo Update to latest version and adapt (and needs jQuery update as well): {@link http://github.com/swisnl/jQuery-contextMenu}
 * @version 1.0.1
 *
