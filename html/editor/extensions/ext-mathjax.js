...
export default {
  ...
  async init ({$, importLocale}) {
    ...
    const /* mathjaxConfiguration = `<script type="text/x-mathjax-config">
      ...
      // Had been on http://c328740.ssl.cf1.rackcdn.com/mathjax/latest/MathJax.js?config=TeX-AMS-MML_SVG.js
      // Obtained Text-AMS-MML_SVG.js from http://cdnjs.cloudflare.com/ajax/libs/mathjax/2.3/config/TeX-AMS-MML_SVG.js
      ...
      events: {
        async click () {
          ...
          if (mathjaxLoaded === false) {
            ...
            //   providing an ES6 module export: http://github.com/mathjax/MathJax/issues/1998
            /*
