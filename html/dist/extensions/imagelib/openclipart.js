(function () {
  ...
  Todos inspired by JsonML: http://github.com/mckamey/jsonml/blob/master/jsonml-html.js
                ...
                if (_typeof$1(val) === 'object') {
                  ...
                  for (var p in val) {
                    if ({}.hasOwnProperty.call(val, p)) {
                      procValue.push(p + '=' + '"' + // http://www.w3.org/TR/xml-stylesheet/#NT-PseudoAttValue
                      val[p].replace(/"/g, '&quot;') + '"');
                    }
                  }
    ...
    function parseDOM(node, namespaces) {
      ...
      */
      ...
      switch (type) {
        ...
        case undefined: // Treat as attribute node until this is fixed: http://github.com/jsdom/jsdom/issues/1641 / http://github.com/jsdom/jsdom/pull/1822
  ...
  */
  ...
  manipulation($$1, jml);
  var baseAPIURL = 'http://openclipart.org/search/json/';
