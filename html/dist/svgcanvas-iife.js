var SvgCanvas = (function () {
  ...
  * http://github.com/progers/pathseg
  *
  * This is a drop-in replacement for the `SVGPathSeg` and `SVGPathSegList` APIs
  * that were removed from SVG2 ({@link http://lists.w3.org/Archives/Public/www-svg/2015Jun/0044.html}),
  ...
  (function () {
    if (!('SVGPathSeg' in window)) {
      ...
      if (!('getPathSegAtLength' in SVGPathElement.prototype)) {
        ...
        // Spec: http://www.w3.org/TR/SVG11/single-page.html#paths-__svg__SVGPathElement__getPathSegAtLength
  ...
  * See {@link http://api.jquery.com/attr/} for basic documentation of `.attr()`.
  *
  ...
  */
  ...
  var supportsNativeSVGTransformLists_ = function () {
    ...
    var isSVGTransform = function isSVGTransform(o) {
      // http://developer.mozilla.org/en-US/docs/Web/API/SVGTransform
    ...
    */
    ...
    _createClass(Path, [{
      ...
      */
      ...
      /**
      * @param {?Integer} newType See {@link http://www.w3.org/TR/SVG/single-page.html#paths-InterfaceSVGPathSeg}
      * @returns {void}
      */
  ...
  */
   ...
   * @param {string} letter - path segment command (letter in potentially either case from {@link module:path.pathMap}; see [SVGPathSeg#pathSegTypeAsLetter]{@link http://www.w3.org/TR/SVG/single-page.html#paths-__svg__SVGPathSeg__pathSegTypeAsLetter})
    ...
    return (
      /** @lends module:path.pathActions */
      {
        ...
        */
        ...
        /**
        * @param {?Integer} v See {@link http://www.w3.org/TR/SVG/single-page.html#paths-InterfaceSVGPathSeg}
        * @returns {void}
        */
  ...
  */
  ...
  /**
   * Used to prevent the [Billion laughs attack]{@link http://en.wikipedia.org/wiki/Billion_laughs_attack}.
  ...
  */
  ...
  /**
   * @see {@link http://api.jquery.com/jQuery.data/}
  ...
  */
  ...
  // MIT License
  // From: http://github.com/uupaa/dynamic-import-polyfill/blob/master/importModule.js
        ...
        if (xform.type === 0) {
          ...
          if (isIdentity(xform.matrix)) {
            if (noi === 1) {
              ...
              // See http://bugs.chromium.org/p/chromium/issues/detail?id=843901
        ...
        Object.keys(this.selectorGrips).forEach(function (dir) {
          var grip = svgFactory_.createSVGElement({
            ...
            attr: {
              ...
              // see http://bugzilla.mozilla.org/show_bug.cgi?id=500174
              'stroke-width': 2,
              'pointer-events': 'all'
            }
          });
  ...
  function SvgCanvas(container, config) {
    ...
    */
    ...
    var clearSvgContentElement = canvas.clearSvgContentElement = function () {
      ...
      var comment = svgdoc.createComment(' Created with SVG-edit - http://github.com/SVG-Edit/svgedit');
    ...
    *
    * Reference:
    * Firefox does not implement `getIntersectionList()`, see {@link http://bugzilla.mozilla.org/show_bug.cgi?id=501421}.
    ...
    */
    ...
    /**
     * Creating a cover-all class until {@link http://github.com/jsdoc3/jsdoc/issues/1545} may be supported.
          ...
          case 'resize':
            {
              ...
              if (hasMatrixTransform(tlist)) {
                ...
                if (supportsNonScalingStroke()) {
                  ...
                  // http://code.google.com/p/svg-edit/issues/detail?id=904
                  // Chromium issue: http://code.google.com/p/chromium/issues/detail?id=114625
          ...
          case 'fhpath':
            {
              ...
              // to separate all coordinates, see http://bugs.webkit.org/show_bug.cgi?id=29870
              sumDistance = 0;
              controllPoint2 = {
                x: 0,
                y: 0
    ...
    */
    ...
    this.save = function (opts) {
      ...
      saveOptions.apply = true; // no need for doctype, see http://jwatt.org/svg/authoring/#doctype-declaration
      ...
      try {
        ...
        if (useExisting) {
          ...
          if (isGecko()) {
            ...
            // http://bugzilla.mozilla.org/show_bug.cgi?id=353575
    ...
    * @param {Integer} newType - New segment type. See {@link http://www.w3.org/TR/SVG/paths.html#InterfaceSVGPathSeg} for list
    * @returns {void}
    */
