// http://github.com/DevExpress/testcafe
// http://devexpress.github.io/testcafe/documentation/test-api/
// http://github.com/helen-dikareva/axe-testcafe
...
async function axeCheckWithConfig (t) {
  const /* error, */ {violations} = await axeCheck(
    t,
    // context: http://github.com/dequelabs/axe-core/blob/develop/doc/API.md#context-parameter
    undefined,
    // http://github.com/dequelabs/axe-core/blob/develop/doc/API.md#options-parameter
    {
      rules: {
        'meta-viewport': {enabled: false}
      }
    }
    // , (err, results) {} // http://github.com/dequelabs/axe-core/blob/develop/doc/API.md#results-object
  );
...
test('Editor - no parameters', async (t) => {
  await axeCheckWithConfig(t); // , axeContent, axeOptions: http://github.com/dequelabs/axe-core/blob/develop/doc/API.md#api-name-axerun
});
...
// Waiting for http://github.com/DevExpress/testcafe-hammerhead/issues/1725 (also http://github.com/DevExpress/testcafe/issues/2734 )
/**
